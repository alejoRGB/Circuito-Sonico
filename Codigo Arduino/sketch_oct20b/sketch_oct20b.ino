...
//Este es el codigo para una instalación interactiva hecha con un ARDUINO UNO.
//El repositorio con todo lo necesario para armar la instalación se encuentra en el 
//siguiente link: https://github.com/alejoRGB/Circuito-Sonico
//Contacto: masalejo8@gmail.com
//Instagram: @alejo_RGB



//Aca se definen los 10 sensores de 
//capacitancia. Se puede poner un sensor en cada
//pin digital, se puede cambiar la cantidad de sensores 
//segun la conveciencia. 
...
//Esto es cuan sensible son los sensores de capacitancia. Mas alto el valor, 
//más sensible los sensores. La sensibilidad tambien depende de 
//el valor de la resistencia que se use. 
...
//El codigo basicamente lo que hace es checkear el valor
//de cada sensor, y si es mayor que el Threshold, envía una
//señal SERIAL a la computadora que es interpretada por un
//programa que se llama HAIRLESS midi-serial. 
//Los mensajes seriales 124, 122, 60, etc. corresponden a los
//mensajes midi NoteOn, NoteOff, etc. Se puede ver el
//diccionario de como funciona el lenguaje midi aqui:
